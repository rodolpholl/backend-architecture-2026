...
using FinControl.Entries.Core.Outbox;
using FluentValidation;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;

namespace FinControl.Entries.Core.Features;

/// <summary>
/// Extensões de DI para registrar handlers, validators e endpoints do módulo Entries.
/// 
...
{
    /// <summary>
    /// Registra todos os handlers, validators e endpoints do módulo Entries.
    /// 
    ...
    {
        // Registrar Wolverine com descoberta automática de handlers no assembly do Entries.Core
